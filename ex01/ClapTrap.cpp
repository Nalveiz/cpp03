...
/*   Updated: 2024/11/05 15:21:37 by musozer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap():name("Default") {
    ...
    this->energy = 10;
    this->damage = 0;
	std::cout << "\033[1;36mClapTrap " << this->name << " default created!\033[0m" << std::endl;
}
...
ClapTrap::ClapTrap(const std::string& name){
    ...
    this->energy = 10;
    this->damage = 0;
    std::cout << "\033[1;36mClapTrap " << this->name << " created!\033[0m" << std::endl;
}

ClapTrap::ClapTrap(const ClapTrap& n){
	std::cout << "\033[1;36mClapTrap " << this->name << " copy constructor called!\033[0m" << std::endl;
	this->name = n.name;
	this->hit = n.hit;
...
ClapTrap& ClapTrap::operator=(const ClapTrap& n){
	if (this != &n){
		...
		this->energy = n.energy;
		this->damage = n.damage;
		std::cout << "\033[1;36mClapTrap " << this->name << " assignment operator called!\033[0m" << std::endl;
	}
	return *this;
}
...
ClapTrap::~ClapTrap(){
	std::cout << "\033[1;105mClapTrap " << this->name << " destroyed!\033[0m" << std::endl;
}
