...
/*   Updated: 2024/11/05 16:21:58 by musozer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ScavTrap::attack(const std::string& name){
	if (this-> hit == 0 || this-> energy == 0)
		...
		this->energy--;
		std::cout << "🔫 \033[1;34mScavTrap " << this->name << " unleashes a powerful attack on "
        	  << name << ", causing " << this->damage << " damage points!\033[0m 🔫" << std::endl;
	}
}

ScavTrap::~ScavTrap(){
	std::cout << "\033[1;106mScavTrap " << this->name << " destroyed!\033[0m" << std::endl;
