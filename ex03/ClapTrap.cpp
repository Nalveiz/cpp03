...
/*   Updated: 2024/11/05 16:19:14 by musozer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : name("Default") {
    ...
    this->energy = 10;
    this->damage = 0;
	std::cout << "\033[1;96mClapTrap " << this->name << " default created!\033[0m" << std::endl;
}
...
ClapTrap::ClapTrap(const std::string& name){
    ...
    this->energy = 10;
    this->damage = 0;
    std::cout << "\033[1;96mClapTrap " << this->name << " created!\033[0m" << std::endl;
}

ClapTrap::ClapTrap(const ClapTrap& n){
	std::cout << "\033[1;96mClapTrap " << this->name << " copy constructor called!\033[0m" << std::endl;
	this->name = n.name;
	this->hit = n.hit;
...
ClapTrap& ClapTrap::operator=(const ClapTrap& n){
	if (this != &n){
		...
		this->energy = n.energy;
		this->damage = n.damage;
		std::cout << "\033[1;96mClapTrap " << this->name << " assignment operator called!\033[0m" << std::endl;
	}
	return *this;
}
...
void ClapTrap::attack(const std::string& target){
	if (this-> hit == 0 || this-> energy == 0)
		...
		this->energy--;
        std::cout << "🔫 \033[1;34mClapTrap " << this->name << " attacks " << target << " causing " << this->damage << " points of damage!\033[0m 🔫" << std::endl;
	}
}
...
void ClapTrap::setTypeHit(unsigned int hitpoint){
	this->hit = hitpoint;
	std::cout << "🆕\033[1;106mClapTrap " << this->name << " hit point has been updated to '" << this->hit << "'!\033[0m🆕" << std::endl;
}

void ClapTrap::setTypeEneryg(unsigned int energypoint){
    this->energy = energypoint;
	std::cout << "🆕\033[1;106mClapTrap " << this->name << " energy point has been updated to '" << this->energy << "'!\033[0m🆕" << std::endl;

}

void ClapTrap::setTypeDamage(unsigned int damagepoint){
    this->damage = damagepoint;
	std::cout << "🆕\033[1;106mClapTrap " << this->name << " attack damage has been updated to '" << this->damage << "'!\033[0m🆕" << std::endl;
