...
/*   Updated: 2024/11/05 16:20:35 by musozer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap() : ClapTrap(){
	...
	this->energy = 100;
	this->damage = 30;
	std::cout << "\033[1;34mFragTrap " << this->name << " default created!\033[0m" << std::endl;
}
...
FragTrap::~FragTrap(){
	std::cout << "\033[1;104mFragTrap " << this->name << " destroyed!\033[0m" << std::endl;
}
