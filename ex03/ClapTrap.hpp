...
/*   Updated: 2024/11/05 16:17:07 by musozer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ClapTrap
{
	...
	public:
		...
		void setTypeHit(unsigned int hitpoint);
		void setTypeEneryg(unsigned int energypoint);
		void setTypeDamage(unsigned int damagepoint);
